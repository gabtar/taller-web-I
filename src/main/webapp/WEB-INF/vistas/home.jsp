...
<div class="w3-main " style="margin-left:340px;margin-right:40px">
    <div class="w3-container">
        <h2 class="w3-center"><p>Se tiene que poner un carrucel con fotos de gentes felices metiendo cosas en lockers/p></h2>

    </div>

    <div class="w3-container">
        <h2 class="w3-center"><p>Suucursales as dasdasd</p></h2>
        <table class="w3-table-all">
            <thead>
            <tr class="w3-red w3-center">
                <th class="w3-center">Sucursal</th>
                <th class="w3-center">Nombre</th>
                <th class="w3-center">Direccion</th>
            </tr>
            </thead>
